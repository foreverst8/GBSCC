...
if(count($result_search)>0){
	if($result_user[0]['main']=="y"){	
		...
		echo "&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<a href=\"del_info_mysql.php?id=".$RgRID."&database=reagent\"><input type=\"button\" name=\"button3\" class=\"button\" id=\"button3\" onclick=\"javascript:return window.confirm('confirm to delete this Request?');\"  value=\"Delete \" /></a>";
		echo "</form>";
	}
	else{

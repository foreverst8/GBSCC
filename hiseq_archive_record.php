...
if (!$res){
	echo "Sample Set faild<br>";
	echo '<br>Something went wrong with the scripts.<br /><br><br>';	
	echo "UPDATE genomics_core.hiseq_sample SET $value where Hiseq_Sample_ID='".$Hiseq_Sample_ID."'<br>";		
	exit;	
}
else{
	echo "Sample is set to Seq_later. Sample ID: $Hiseq_Sample_ID<br>";
}
echo "<br>";

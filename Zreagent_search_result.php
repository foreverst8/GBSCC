...
<table>
  <tr>
	...
	if($RgRID=="" and $keywords==""){
		...
		if($RgRID!=""){
			$query="select * from genomics_core.reagent where RgRID='".$RgRID."'";
			if($result_user[0]['main']!="y"){
				$query.=" where Submitter_Name='".$_SESSION['username']."'";
			}
		}
	...
	if(count($result_search)==0){
		...
		echo "<td>";
		echo "Aline PCR Bottle clean up DX beads , #C1003";
		echo "</td>";
		
		echo "<td>";
		echo "Aline Size selector-1 beads, #Z-6001, (1mL Per Tube)";
		echo "</td>";

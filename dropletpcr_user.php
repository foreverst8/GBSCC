...
<hr>
<br>
<h6>Droplet Digital PCR Booking History</h6><br>
<table>
    <tr>
...
<?php
$history=search("select * from genomics_core.ddpcr where user='".$_SESSION['username']."' order by id DESC");
...
if(count($history)>0){
    ...
    for ($i = 0; $i < count($history); $i++) {
        ...
        echo "<td>";
        echo "<a href=\"dropletpcr_edit.php?&id=".$history[$i]['id']."\"><input type=\"button\" class=\"button\" name=\"button3\" id=\"button3\" value=\"Edit\" /></a>";
        echo "&nbsp&nbsp";
        echo "<a href=\"dropletpcr_delete.php?database1=ddpcr&database2=ddpcr_booking&id=" . $history[$i]['id'] . " \"><input type=\"button\" class=\"button\" name=\"button3\" id=\"button3\" value=\"Cancel\" /></a>";
        echo "</td>";

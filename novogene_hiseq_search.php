...
<form action="novogene_hiseq_search_result.php" method="get">
	<input type="hidden" value="novo_hiseq" name="database" id="database" />
	<table width="300" border="0" cellspacing="3" align="left">
		<tr>
		<td align="right">Run: </td>
		<td><input type="text" size="20" name="run" id="run"/></td>
	  </tr>
	  <tr>
	  <tr>

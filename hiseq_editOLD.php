...
if(count($result_sample)<1){
	echo "Could not find the record.<br>";
		...
		echo "<p>SAMPLE INFORMATION</b><br><br>";
		...
		echo "<option value=\"3_end_adapor\" >3'end of adaptor</option>";
		echo "<option value=\"on_adaptor\" >on adaptor</option>";
		echo "</select>";
		echo "</td>";
		echo "</tr>";
		...
		echo "</td>";
		echo "<td align=\"left\">";
		echo "<span style=\"font-size:12px;color:gray\">&nbsp;if need core to analyze the data,<br> &nbsp;please list brief purpose of the library.<br>&nbsp;(like what's the case/control,<br>what need core to do)</span>";
		echo "</td>";
		...
		if(count($result_Library)<1){
			...
			echo  "<span style=\"font-size:13px\"><b>Libraries information</b></span><br><br>";
			echo "<table border=\"2\" cellspacing=\"0\" cellpadding=\"0\" bordercolor=\"#999999\" >";
			echo "<tr align=\"center\">";
			echo "<td>";
			echo "Library ID";

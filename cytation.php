...
<hr>
<br>
<h6>Cytation Imaging Reader Booking</h6><br>
<table>
    <tr>
...
<p style="font-size:18px;color:red"><b>Your booking history: <a class="button" href="cytation_user.php">Click</a></b></p><br><br>
...
<form name="cytation" action="cytation_add_mysql.php#top" method="get">
    ...
    <input class="button" type="submit" onclick="javascript:{this.disabled=true;document.cytation.submit();}">

...
<hr>
<br>
<h6>Freeze-drier Reservation</h6>
<table>
    <tr>
...
$id=$_GET['id'];
$overlap=search("select * from genomics_core.freezedrier where not id='$id'");
...
$res = $conn->query("UPDATE genomics_core.freezedrier SET startdate = '$startdate' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier SET starttime = '$starttime' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier SET enddate = '$enddate' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier SET endtime = '$endtime' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier SET first = '$first' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier SET last = '$last' WHERE id='$id'");

$res = $conn->query("UPDATE genomics_core.freezedrier_booking SET title = '$title' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier_booking SET start = '$start' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.freezedrier_booking SET end = '$end' WHERE id='$id'");

...
$overlap=search("select * from genomics_core.ddpcr");
...
$result_tmp=search("select max(id) from genomics_core.ddpcr");
...
$res1 = $conn->query("INSERT INTO genomics_core.ddpcr ($name1) VALUES (" . $value1 . ")");
$res2 = $conn->query("INSERT INTO genomics_core.ddpcr_booking ($name2) VALUES (" . $value2 . ")");
...
if (!$res1 && !$res2) {
    ...
    $Subject="Droplet Digital PCR Booking: $user from $lab";

    if($email != ""){

        $main_mesg = "Dear Core User,<br><br>Your booking for Droplet Digital PCR is confirmed. Time slot: $startdate $starttime to $enddate $endtime.<br><br>You can edit your booking by clicking <a href=\"http://161.64.198.12/GBSCC/dropletpcr_edit.php?id=$id\">this link</a>. If you would like to cancel this booking, please click <a href=\"http://161.64.198.12/GBSCC/dropletpcr_user.php\">this link</a>.<br><br>This is an automated email from <a href=\"http://161.64.198.12/GBSCC/index.php\">Core Database</a>. Please do not reply to this email. For any queries, please contact the Core support team.<br><br>";

...
<hr>
<br>
<h6>Edit Droplet Digital PCR Booking</h6><br>
<table>
    <tr>
...
$edit=search("select * from genomics_core.ddpcr where id='$id'");
if ($edit != "") {
    ...
    echo "<br><br>";
    echo "<form name=\"dropletpcr_edit\" action=\"dropletpcr_edit_mysql.php#top\" method=\"get\">";

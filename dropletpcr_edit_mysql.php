...
<hr>
<br>
<h6>Droplet Digital PCR Booking</h6>
<table>
    <tr>
...
$id=$_GET['id'];
$overlap=search("select * from genomics_core.ddpcr where not id='$id'");
...
$res = $conn->query("UPDATE genomics_core.ddpcr SET startdate = '$startdate' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr SET starttime = '$starttime' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr SET enddate = '$enddate' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr SET endtime = '$endtime' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr SET first = '$first' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr SET last = '$last' WHERE id='$id'");

$res = $conn->query("UPDATE genomics_core.ddpcr_booking SET title = '$title' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr_booking SET start = '$start' WHERE id='$id'");
$res = $conn->query("UPDATE genomics_core.ddpcr_booking SET end = '$end' WHERE id='$id'");
